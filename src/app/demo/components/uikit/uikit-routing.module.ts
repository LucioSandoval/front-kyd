...
@NgModule({
    imports: [RouterModule.forChild([
        ...
        { path: 'formlayout', data: { breadcrumb: 'Form Layout' }, loadChildren: () => import('./employee/employee.module').then(m => m.EmployeeModule) },
        ...
        { path: 'table', data: { breadcrumb: 'Table' }, loadChildren: () => import('./company/company.module').then(m => m.CompanyModule) },
